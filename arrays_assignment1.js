...
/*let user = ["Lokesh", "25", "India"];
let csvRow = user.join(",");
console.log(csvRow);*/
...
/*let orders = ["Burger", "French Fries", "Coke", "Salad"];
let cancelled = orders.pop();
...
function addToCart(item) {
  cart.push(item);
  console.log(`${item} added to Cart.Total items: ${cart.length}`);
}
...
/*let cart = ["Apple", "Orange", "Banana", "Orange"];
let index = cart.lastIndexOf("Orange");
if (index !== -1) {
  cart.splice(index, 1);
}
console.log(cart);*/
